...
class MercadoPagoController extends Controller
{
    ...
    public function createPaymentPreference(Request $request)
    {
        ...
        $payer = [
            "name" => $request->input('name', 'Pepito'), // Para obtener el nombre del request o usar un valor predeterminado
            "surname" => $request->input('surname', 'Pérez'),
            "email" => $request->input('email', 'pepitoperez@thewinnernumber.com'),
        ];

...
class DiscordServices
{
    ...
    public function discordNotification($tittle ,$typeMessage, $authMethod, $userId, $userName, $userEmail, $userRole, $notificationMessage)
    {
        ...
        $this->sendDiscordMessageNotification($message);
    }

    public function discordErrorNotification($type, $message, $file, $line, $code)
    {
        $message = [
            'embeds' => [
                [
    ...
    public function sendDiscordMessageNotification($messagecompleted)
    {
